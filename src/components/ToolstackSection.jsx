...
const toolsData = [
  ...
  { id: 14, symbol: 'Cc', name: 'claude code', category: 'build & web', color: '#D97706' },
  { id: 15, symbol: 'Ag', name: 'antigravity', category: 'build & web', color: '#0D9488' },

  // AI & Assist
  { id: 16, symbol: 'Mj', name: 'midjourney', category: 'ai & assist', color: '#2563EB' },
  { id: 17, symbol: 'Ff', name: 'firefly', category: 'ai & assist', color: '#FF2A00' },
  { id: 18, symbol: 'Nb', name: 'runway', category: 'ai & assist', color: '#10B981' },
  // { id: 21, symbol: 'Hf', name: 'huggingface', category: 'ai & assist', color: '#EAB308' },
  { id: 20, symbol: 'Ch', name: 'chatgpt', category: 'ai & assist', color: '#10A37F' },
  { id: 21, symbol: 'Ge', name: 'gemini', category: 'ai & assist', color: '#6366F1' },
  { id: 22, symbol: 'Cl', name: 'claude', category: 'ai & assist', color: '#EA580C' },
  { id: 23, symbol: '11', name: 'elevenlabs', category: 'ai & assist', color: '#64748B' },
